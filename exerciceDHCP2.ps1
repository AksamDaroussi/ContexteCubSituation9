...
#Demander à l'utilisateur le nom de l'étendue DHCP, l'adresse réseau de l'étendue, le masque sous-réseau, la 1ère adresse, la dernière adresse, la passerelle, le nom  du domaine et l'adresse IP du serveur de domaine
